...
Reaction time (end-to-end) | [minimum 3.8s (estimated average 5-7s)](./near-indexer-framework#limitations) | [minimum 3.9s (estimated average 6-8s)](#limitations)
