...
`ExecutionOutcomes.logs` is an array of strings. And it's not guaranteed that all the elements are Events-compatible. We might have just a string log element.
